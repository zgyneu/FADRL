...
def get_options(args=None):
    ...
    parser.add_argument('--graph_size', type=int, default=50, help="T number of customers in the targeted problem (graph size)")
    ...
    parser.add_argument('--T_max', type=int, default=1000, help='number of steps for inference')
    ...
    parser.add_argument('--val_dataset', type=str, default = None, help='dataset file path')
    ...
    parser.add_argument('--ortools', action='store_true', help='compare with or-tools')
    
    opts = parser.parse_args(args)
    # opts.val_m = opts.graph_size // 2
    ...
    opts.eval_only = True
    # opts.ortools = True
    # opts.resume = './outputs/pdtsp_20/VRP20/run_name_20231021T212427/epoch-199.pt'
    # opts.load_path = './pre-trained/vrp/vrp20.pt'
    # opts.load_path = './pre-trained/vrp/vrp50.pt'
    # opts.load_path = './pre-trained/pdtsp/20/epoch-156.pt'
    # opts.load_path = './pre-trained/pdtsp/50/epoch-196.pt'
    # opts.load_path = './pre-trained/pdtsp/100/epoch-195.pt'
    # opts.load_path = './outputs/pdtsp_50/run_name_20240130T121056/epoch-116.pt'
    # opts.val_dataset = './datasets/tsp20.pkl'
    # opts.val_dataset = './datasets/pdp_50.pkl'
    # opts.val_dataset = './datasets/pdp_100.pkl'
    # opts.val_dataset = './datasets/vrp_20.pkl'
    # opts.val_dataset = './datasets/vrp_50.pkl'
